 ...
 *Esta máquina de estados indica el estado de lo que se muestra en la pantalla en funcion de presionar un único
 *botón.
 *Se encuentra en un estado Iddle inicial, se presiona el boton para mostrar los valores de aceleracion del
 *ADXL345 y, al presionar nuevamente el boton, regresa al estado Iddle inicial
 */

#include "API_mefLcd.h"
